...
libraryDependencies ++= Seq(
    ...
    // test dependencies
    "com.fasterxml.jackson.datatype" % "jackson-datatype-joda" % "2.4.0-rc3" % "test",
    "com.fasterxml.jackson.datatype" % "jackson-datatype-guava" % "2.4.0-rc3" % "test",
    "com.fasterxml.jackson.module" % "jackson-module-jsonSchema" % "2.4.0-rc3" % "test",
